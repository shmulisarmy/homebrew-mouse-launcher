class MouseLauncher < Formula
  ...
  homepage "https://github.com/shmuliklein/mouse-launcher"
  version "1.0.0"
  
  if OS.mac?
    url "https://github.com/shmuliklein/mouse-launcher/releases/download/v1.0.0/mouse_launcher_darwin_amd64"
